...
//Extend the trucks module, trucks.js provided with the following methods:
//getTrucks This method takes no parameters and returns a list of all the truck objects in the module.
...
//getTruck(name) This method takes one parameter, a string representing the name of a food truck. The function returns the truck object matching the name provided. 
...
var getTruck = function (name) {
    for (var i = 0; i < foodTrucks.length; i++) {
        if (name === foodTrucks[i].name) {
            ...
            return 'Sorry No truck';
        }
    }
};

// getFoodTypes This method takes no parameters and returns a list of all the food types offered by the various trucks in the module. 
...
// filterTrucksByDay(day) This method takes one parameter, a string representing a day of the week. The function returns the list of trucks open on the day provided.
var filterByDay = function (day) {
    var truckList = [];
    for (var i = 0; i < foodTrucks.length; i++) {
        if (foodTrucks[i].schedule) {
            for (var j = 0; j < foodTrucks[i].schedule.length; j++) {
                var dayOfTruck = foodTrucks[i].schedule[j];
                if (dayOfTruck === day) {
...
// filterTrucksByFoodType(foodType) This method takes one parameter, a string representing a food type. The function returns the list of trucks that serve the provided type of food. 
